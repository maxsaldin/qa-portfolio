...
- [ ] Воспроизведение видео по клику play  
- [ ] Изменение громкости ползунком/скроллбаром  
- [ ] Пауза при клике на экран или нажатии пробела  
- [ ] Переключение в режим полного экрана  
- [ ] Перемотка видео при клике по полосе  
- [ ] Открытие меню настроек  
- [ ] Включение/выключение субтитров  
- [ ] Переключение в режим широкого экрана  
- [ ] Переключение плеера в свёрнутый режим  
...
✅ **Что это показывает**:
- Вы умеете **работать без предварительных инструкций** (Exploratory Testing).
- Вы умеете **находить баги**.
- Вы умеете **оформлять их по стандарту** (шаги, окружение, приоритет).
