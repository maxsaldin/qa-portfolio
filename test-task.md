...
### 📜 Текст задания:
> Кратко опишите процесс проведения Compatibility Testing сайта по следующим критериям: операционная система, разрешение экрана, браузер.

---

### ✅ Моя работа:

**Цель**: Проверка корректной работы сайта в разных конфигурациях (операционные системы, браузеры, разрешения экрана).

> Тестирование совместимости (Compatibility Testing) проводится для того, чтобы убедиться, что сайт работает одинаково во всех поддерживаемых окружениях.
...
✅ **Что это показывает**:
- Вы понимаете, что такое **совместимость**.
- Вы умеете **планировать тестирование** по ключевым параметрам.
- Вы знаете, какие **окружения важны** для тестирования.
